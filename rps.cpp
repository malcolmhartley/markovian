...
int main(int argc, char** argv) {
    ...
    if (argc == 2 && strcmp(argv[1], "help") == 0) {
        ...
        cout << "\033[3mUsage: rps [user] [n]\n\n\033[0m";
        cerr << "\033[1;31merror:\033[1;0m missing a mandatory option. Try 'rps help' for more info.\n";
        return 1;
    } else if (argc == 3) {
        cout << "Welcome to paper scissors \033[1;31mshoot!\033[1;0m\n\nEnter a move below to begin:\n";
    } else {
        cerr << "\033[1;31merror:\033[1;0m program takes 2 arguments (" << argc-1 << " supplied). Try 'rps help' for more info.\n";
        return 1;
    }
